...
#ifndef ECE563_PROJECT1_SP_REGISTER_H
#define ECE563_PROJECT1_SP_REGISTER_H
...
typedef enum {
    LW, SW, ADD, ADDI, SUB, SUBI, XOR, BEQZ, BNEZ, BLTZ, BGTZ, BLEZ, BGEZ, JUMP, EOP, NOP
} opcode_t;
...
#endif //ECE563_PROJECT1_SP_REGISTER_H
