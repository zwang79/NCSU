...
int main(int argc, char **argv){
	...
	mips->load_program("C:\\Users\\Joshmosh\\OneDrive\\Documents\\Classes\\Senior Second Semester\\ECE 563\\project1_code\\c++\\asm\\data_dep1.asm", 0x10000000);
	...
	for (i = 0x0, j=1; i<0x20; i+=4, j+=1) mips->write_memory(i,j);
