...
set_ignored_layers -rc_congestion_ignored_layers {MINT4 MINT5 MSMG1 MSMG2 MSMG3 MSMG4 MSMG5 MG1 MG2 } -min_routing_layer {M1} -max_routing_layer {MINT3} -verbose
