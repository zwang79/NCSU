...
set DESIGN_NAME                   "MulDiv"  ;#  The name of the top-level design

set DESIGN_REF_DATA_PATH          "../src/rtl/proj1"  ;#  Absolute path prefix variable for library/design data.
...
set ADDITIONAL_SEARCH_PATH        "../src/rtl/proj1"  ;#  Additional search path to be added to the default search path
