...
-max_routing_layer $MSCTS_CLOCK_MESH_ROUTE_MAX_ROUTING_LAYER [get_nets $MSCTS_CLOCK_MESH_NAME]
...
-driver_subckt_files $MSCTS_ANALYZE_DRIVER_FILES \
-spice_header_files $MSCTS_ANALYZE_SPICE_HEADER_FILES \
-clock $MSCTS_CLOCK \
-configuration { \
